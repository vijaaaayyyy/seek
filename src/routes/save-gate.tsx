  ...
  return (
    <div className="flex min-h-[calc(100dvh-11rem)] flex-col items-center justify-center px-2 py-6">
      <div className="w-full max-w-[360px] text-center">
        <h1 className="font-serif text-[2.35rem] leading-none font-medium tracking-tight text-ink">
          Oh noo!
        </h1>
        <p className="mx-auto mt-3 max-w-[260px] font-sans text-[14px] leading-relaxed text-muted">
        ...
        <div className="mt-6">
          <Link
            to="/login"
            search={{ redirect }}
            className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-ink px-5 font-sans text-[14px] font-medium text-paper transition-transform duration-150 active:scale-[0.97] dark:bg-paper dark:text-ink"
          >
