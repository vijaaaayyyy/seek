    ...
    <>
      <div className="relative hidden lg:block">
        <section className="relative flex min-h-dvh flex-col overflow-hidden">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <img src="/canopy-hero.webp" alt="" className="h-full w-full object-cover object-center" decoding="async" fetchPriority="high" />
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_55%_50%_at_50%_45%,transparent_0%,rgba(10,14,10,0.25)_70%,rgba(10,14,10,0.55)_100%)]" />
            ...
            <div className="flex h-11 w-fit max-w-[min(100%,40rem)] items-center gap-1 rounded-full bg-white/85 px-2.5 shadow-sm ring-1 ring-black/8 backdrop-blur-xl dark:bg-black/50 dark:ring-white/12">
              ...
              <nav className="flex items-center gap-0.5">
                {[
                  ...
                  <Link key={l.to} to={l.to} className="rounded-full px-3 py-1.5 font-sans text-[12.5px] font-medium text-muted transition-colors hover:text-ink">
                    {l.label}
                  </Link>
                ))}
              </nav>
              <div className="ml-1 flex items-center gap-1 border-l border-line pl-2">
                <ThemeToggle />
                <Link to="/login" search={{ redirect: "/" }} className="rounded-full bg-ink px-3.5 py-1.5 font-sans text-[12.5px] font-medium text-paper transition-opacity hover:opacity-90">
                  Sign in
                </Link>
              </div>
            </div>
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-20 pt-24 text-center">
            ...
            <p className="mx-auto mt-4 max-w-md font-sans text-[15px] leading-relaxed text-white/90 drop-shadow-sm">
              Search Scripture for the love that never fails — the mercy that meets us, the sacrifice that saves, the agape of God.
            </p>
            ...
            <form onSubmit={submit} className="mt-8 w-full max-w-md">
              <div className="flex items-center gap-0 rounded-full bg-white/95 p-1.5 shadow-[0_16px_48px_rgba(0,0,0,0.28)] ring-1 ring-black/5">
                ...
                />
                <button type="submit" aria-label="Search" className="flex size-11 shrink-0 items-center justify-center rounded-full bg-ink text-paper transition-transform active:scale-95">
            ...
            <div className="mt-5 flex flex-wrap justify-center gap-2">
              {EXAMPLES.map((ex) => (
                <button key={ex.q} type="button" onClick={() => runExample(ex.q)} className="rounded-full bg-white/20 px-3.5 py-1.5 font-sans text-[12.5px] text-white ring-1 ring-white/35 backdrop-blur-md transition-colors hover:bg-white/30">
                  “{ex.label}”
                </button>
              ))}
            </div>
        ...
        <section className="relative bg-paper px-6 pt-12 pb-16 text-ink">
          <div className="mx-auto max-w-5xl">
            <p className="mx-auto max-w-2xl text-center font-serif text-[1.35rem] leading-snug text-ink">
              ...
              <span className="mt-2 block font-sans text-[13px] text-muted">1 John 4:7</span>
            </p>

            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-4 gap-3">
              {STATS.map((s) => (
                <div key={s.label} className="rounded-xl border border-line bg-surface px-2 py-3.5 text-center">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2">
              <Link to="/read/$book/$chapter" params={{ book: FEATURED.book, chapter: FEATURED.chapter }} search={{ q: undefined }} className="group rounded-xl border border-line bg-surface p-5 text-left transition-colors hover:bg-wash">
                <div className="flex items-center gap-2 text-forest">
                  ...
                  <span className="font-sans text-[11px] font-semibold tracking-[0.12em] uppercase">The heart of the Gospel</span>
                </div>
                <p className="mt-3 font-serif text-[1.15rem] leading-snug text-ink text-balance">“{FEATURED.text}”</p>
              ...
              <div className="rounded-xl border border-line bg-surface p-5">
                <div className="flex items-center gap-2 text-muted">
                  ...
                  <span className="font-sans text-[11px] font-semibold tracking-[0.12em] uppercase">Seek by the heart</span>
                </div>
            ...
            <section className="mt-4 rounded-xl border border-line bg-surface p-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-muted">
                  ...
                  <span className="font-sans text-[11px] font-semibold tracking-[0.12em] uppercase">Books of love & mercy</span>
                </div>
            ...
            <section className="mt-14">
              ...
              <h2 className="mt-2 text-center font-serif text-[1.75rem] font-medium text-ink">Seek. Receive. Abide.</h2>
            ...
            <section className="mt-14">
              ...
              <h2 className="mt-2 text-center font-serif text-[1.75rem] font-medium text-ink">A quiet place for the Gospel</h2>
            ...
            <section className="mt-14 rounded-xl border border-line bg-surface px-8 py-10 text-center">
              <h2 className="font-serif text-[1.85rem] font-medium text-ink">Come and see</h2>
              <p className="mx-auto mt-2 max-w-md font-sans text-[14px] text-muted">
                Open the King James Bible. Search the love of God, His mercy, and the sacrifice of Christ — and keep the verses that hold you.
              </p>
            ...
            <section id="about" className="mt-14 rounded-xl border border-line bg-surface p-6 md:p-8">
              ...
              <h2 className="mt-2 font-serif text-[1.5rem] font-medium text-ink">Built to point you to Him</h2>
              <p className="mt-3 max-w-2xl font-sans text-[14px] leading-relaxed text-muted">
                SEEK is a quiet place to search and read the King James Bible — the love of God, His mercy toward sinners, the sacrifice of Christ, and the agape that never ends. Scripture text is public domain. SEEK is independent and not affiliated with any denomination.
              </p>
      ...
      <div className="relative -mx-4 -mt-3 flex flex-col lg:hidden">
        <div className="relative overflow-hidden px-5 pb-8 pt-2">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <img src="/canopy-hero.webp" alt="" className="h-full w-full object-cover object-center" decoding="async" />
          ...
          <form onSubmit={submit} className="mx-auto mt-5 w-full max-w-md">
            <div className="relative flex items-center rounded-full bg-white/95 shadow-lg ring-1 ring-black/5">
              ...
              <button type="submit" aria-label="Search" className="absolute top-1/2 right-1.5 flex size-9 -translate-y-1/2 items-center justify-center rounded-full bg-ink text-paper">
                <ArrowRight className="size-4" strokeWidth={2.2} />
              </button>
            </div>
          </form>
        ...
        <div className="bg-paper px-5 pt-6 pb-8 text-ink">
          <Link to="/read/$book/$chapter" params={{ book: FEATURED.book, chapter: FEATURED.chapter }} search={{ q: undefined }} className="block rounded-xl border border-line bg-surface p-4">
          ...
          <section className="mt-5">
            <p className="mb-2.5 font-sans text-[11px] font-medium tracking-[0.14em] text-muted uppercase">Seek by the heart</p>
          ...
          <section className="mt-5">
            <div className="mb-2.5 flex items-center justify-between">
              <p className="font-sans text-[11px] font-medium tracking-[0.14em] text-muted uppercase">Books of love & mercy</p>
          ...
          <div className="mt-6 rounded-xl bg-ink px-5 py-6 text-center">
            <p className="font-serif text-[1.25rem] text-paper">Come and see</p>
          ...
          <section id="about-mobile" className="mt-8 rounded-xl border border-line bg-surface p-4">
            ...
            <p className="mt-2 font-sans text-[13px] leading-relaxed text-ink">A quiet place for the Word — God&apos;s love, mercy, and the sacrifice of Christ. KJV · public domain.</p>
            <div className="mt-3 space-y-1.5 font-sans text-[12px] text-muted">
              ...
              <p><a href={`mailto:${CONTACT_EMAIL}?subject=SEEK%20bug%20report`} className="font-medium text-forest underline-offset-2 hover:underline">Report a bug</a></p>
            </div>
          </section>
        </div>
      </div>
