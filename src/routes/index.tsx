...
const FAQ = [
  {
    q: "What is Seek?",
    a: "Seek is a fast, free way to find any verse in the King James Bible. Type a fragment, a story, or even a feeling — and Seek shows you the passage.",
  },
  {
