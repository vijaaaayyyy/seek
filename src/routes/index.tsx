    ...
    <div className="relative">
      <div className="pointer-events-none fixed inset-0 -z-10">
        <picture>
          ...
          <img src="/canopy-hero.jpg" alt="" className="h-full w-full object-cover object-[center_35%]" decoding="async" fetchPriority="high" />
        </picture>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_30%,transparent_0%,rgba(6,10,8,0.35)_55%,rgba(6,10,8,0.72)_100%)]" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-transparent to-black/55" />
      </div>

      <div className="relative hidden lg:block">
        <section className="relative flex min-h-dvh flex-col">
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-16 pt-28 text-center">
