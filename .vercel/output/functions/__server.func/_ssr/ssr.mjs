...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CDJyKQVf.mjs");
...
var manifest = { "fe2b0aeb1c46ba1794976675d02183430706b641a48650df51472a630d68a82e": {
	functionName: "searchByMeaning_createServerFn_handler",
	importer: () => import("./ai-search-CPg1mMHb.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-FRflzf_r.mjs").then((n) => n.t),
